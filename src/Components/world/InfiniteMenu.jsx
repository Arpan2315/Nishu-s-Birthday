...
export default function InfiniteMenu({ items = [], scale = 1.0 }) {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-black">
      ...
      <h1 className="absolute top-10 w-full text-center z-20 select-none 
          text-white font-bold text-4xl md:text-6xl tracking-widest 
          animate-pulse drop-shadow-[0_0_15px_rgba(255,255,255,0.8)]"
